...
<body>
    <div class="container">
        <div class="left">
            ...
            <div class="label">Total Manqués (€) <span class="tooltip"><span class="tooltip-icon">?</span><span class="tooltiptext">Valeur actuelle des BTC manqués (coût d'opportunité total en milliards €). Formule (BTC minés × prix actuel).</span></span></div>
